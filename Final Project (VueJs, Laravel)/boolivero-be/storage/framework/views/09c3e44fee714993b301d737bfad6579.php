...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="d-flex align-items-center gap-4">
            ...
            <p id='profile-status' class="fs-5 text-muted"><?php echo e(__('Saved.')); ?></p>
            <?php endif; ?>
        </div>
    </form>
</section>
<?php /**PATH C:\laravel\boolivero-be\resources\views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>