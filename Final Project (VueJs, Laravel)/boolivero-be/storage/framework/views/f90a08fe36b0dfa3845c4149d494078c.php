<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__('Una volta eliminato il tuo account, tutte le sue risorse e i dati verranno eliminati definitivamente. Prima di eliminare il tuo account, scarica tutti i dati o le informazioni che desideri conservare.')); ?>
...
<?php /**PATH C:\laravel\boolivero-be\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>